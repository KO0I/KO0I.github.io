...
[Noise music](https://en.wikipedia.org/wiki/Noise_music) is a broad genre that is a bit of a catch-all for all sorts of sounds, especially those typically considered non-musical or even deemed worth avoiding. 

Despite the harsh possibilities, noise textures can also be subtle, ambient, and lush in unexpected ways.

Noise music is also associated with a number of art movements, such as the post WWI surreality of [Dada](https://youtu.be/loxy-YNl0Zk?t=2711), the sample-lovers called [Musique concrète](https://en.wikipedia.org/wiki/Musique_concr%C3%A8te), and being in good company with those exploring atonality or any other variation of liberation from the typical constraints.

But, perhaps the delightful and brief "Dadaist Manifesto" will be fun and informative:

{% include youtube.html id="dloxy-YNl0Zk?t=2711" title="Dada Manifesto" %}
